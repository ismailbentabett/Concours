...
type="button" class="relative block w-full border-2 border-gray-300 border-dashed rounded-lg p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-bittersweet-500">
    ...
    <span class="mt-2 block text-sm font-medium text-white">
        Aucun Posts trouvé ? Ajouter plus
    </span>
</a>
  @endif
