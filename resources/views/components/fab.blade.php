@auth
    {{-- <a href="{{ url('concours') }}" onclick="buttonHandler()" title="Contact Sale"
    ...
    <div class="fixed z-90 bottom-10 right-8  rounded-full drop-shadow-xl flex justify-center items-center text-white text-4xl hover:bg-bittersweet-700 hover:drop-shadow-2xl hover:animate-bounce duration-300"
        style="z-index: 2147483647">
        <a href="{{ url('concours') }}" type="button"
            ...
            <span>Participation au Concours</span>
        </a>
    </div>
@endauth
