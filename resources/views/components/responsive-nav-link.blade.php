...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-bittersweet-400 text-left text-base font-medium text-bittersweet-700 bg-bittersweet-50 focus:outline-none focus:text-bittersweet-800 focus:bg-bittersweet-100 focus:border-bittersweet-700 transition duration-150 ease-in-out'
