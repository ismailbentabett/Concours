            ...
            <div class="relative overflow-hidden">
                                    ...
                                    <div class="flex items-center flex-1 justify-between">
                                        <div class="flex items-center justify-between w-full md:w-auto">
                                            ...
                                            <div class="-mr-2 flex items-center md:hidden">
                                                <button type="button"
                                                    class="bg-transparent rounded-md p-2 inline-flex items-center justify-center text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white"
                                                    aria-expanded="false">
                                        ...
                                        <div class="hidden space-x-8 md:flex md:ml-10">
                                            ...
                                            <a href="#"
                                                class="text-base font-medium text-white hover:text-white">LOGIN</a>
                                            <a href="#"
                                                class="text-base font-medium text-white hover:text-white">SIGNUP</a>
                ...
                -->
                            <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top md:hidden">
                                <div class="rounded-lg 1 bg-gray-900 ring-1 ring-black ring-opacity-5 overflow-hidden">
                                    <div class="px-5 pt-4 flex items-center justify-between">
                                        ...
                                        <div class="-mr-2">
                                            <button type="button"
                                                class="bg-gray-900 rounded-md p-2 inline-flex items-center justify-center text-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-bittersweet-600">
                                    ...
                                    <div class="pt-5 pb-6">
                                        ...
                                        <div class="mt-6 px-5">
                                            <p class="text-center text-base font-medium text-white">Existing
                                                Contestant? <a href="#"
                                                    class="text-white hover:underline">Login</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="relative mt-10">
                        ...
                        <div class="relative   bg-gray-900">
                            <div class="hidden absolute top-0 inset-x-0 h-1/2 bg-gray-900 lg:block"
                                aria-hidden="true">
                            </div>
                            <div class=" mx-auto  lg:bg-transparent lg:px-8">
                                <div class="lg:grid lg:grid-cols-12">
                                    ...
                                    <div
                                        class="relative bg-bittersweet-400 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                                                ...
                                                <defs>
                                                    <pattern id="64e643ad-2176-4f86-b3d7-f2c5da3b6a6d" x="0"
                                                        ...
                                                        <rect x="0" y="0" width="4"
                                                            height="4" class="text-bittersweet-800"
                                                            fill="currentColor" />
                                                    </pattern>
                                                </defs>
                    ...
                    <div class="flex justify-center items-center bg-gray-900 my-10">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="space-y-2">
                                                <div class="text-lg leading-6 font-medium space-y-1">
                                                    <h3 class="text-white">Lindsay Walton</h3>
                                ...
                                <ul role="list"
                                    ...
                                    <li>
                                        <div class="space-y-6">
                                            ...
                                            <div class="space-y-2">
                                                <div class="text-lg leading-6 font-medium space-y-1">
                                                    <h3 class="text-white">Whitney Francis</h3>
                    ...
                    <div class="bg-gray-900">
                        <div class=" mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                            <div class="relative bg-gray-900 1-xl">
                                <h2 class="sr-only">Contact us</h2>

                                <div class="grid grid-cols-1 lg:grid-cols-3">
                                    <!-- Contact information -->
                                    <div class="relative overflow-hidden py-10 px-6 bg-bittersweet-700 sm:px-10 xl:p-12"
                                        ...
                                        <form action="#" method="POST"
                                            ...
                                            <div class="sm:col-span-2">
                                                <div>
                                                    ...
                                                    <x-text-input id="subject" class="block mt-1 w-full" type="text" name="subject" :value="old('subject')" required autofocus autocomplete="username" />
                                            ...
                                            <div class="sm:col-span-2">
                                                ...
                                                <div class="mt-1">
                                                    <textarea id="message" name="message" rows="4"
                                                        class="py-3 px-4 block w-full 1 text-white bg-gray-900 focus:ring-bittersweet-500 focus:border-bittersweet-500 border border-gray-300 rounded-md"
                                                        aria-describedby="message-max"></textarea>
                                                </div>
                                            </div>
                                            <div class="sm:col-span-2 sm:flex sm:justify-end">
                                                <button type="submit"
                                                    class="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md 1 text-base font-medium text-white bg-bittersweet-600 hover:bg-bittersweet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-bittersweet-500 sm:w-auto">
                                                    Submit
                                                </button>
                                            </div>
                                        </form>
