                                        ...
                                        <div class="hidden space-x-8 md:flex md:ml-10  items-center">
                                            ...
                                            @if (Route::has('login'))
                                                <div class="space-x-3 z-10 flex items-start">
                                                    ...
                                                    @else
                                                        <a href="{{ route('login') }}"
                                                            class="inline-flex items-start px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white bg-bittersweet-600 hover:bg-bittersweet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-bittersweet-500">Log
                                                            in</a>
