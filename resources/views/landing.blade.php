...
-->
        <div class="bg-concgreen-500">
            <div class="relative overflow-hidden">
                ...
                <main>
                    <div class="h-screen pt-10 bg-transparent sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden bg-fixed bg-cover bg-center flex flex-col justify-between "
                                    ...
                                    <div class="flex items-center flex-1 justify-between">
                                        <div class="flex items-center justify-between w-full md:w-auto">
                                            ...
                                            <div class="-mr-2 flex items-center md:hidden">
                                                <button type="button"
                                                    class="bg-transparent rounded-md p-2 inline-flex items-center justify-center text-white hover:bg-concgreen-600 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white"
                                                    aria-expanded="false">
