...
-->
        <div class="bg-white">
            <div class="relative overflow-hidden">
                ...
                <main>
                    <div class="h-screen pt-10 bg-transparent sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden bg-fixed bg-cover bg-center "
                                    ...
                                    <div class="flex items-center flex-1 justify-between">
                                        <div class="flex items-center justify-between w-full md:w-auto">
                                            ...
                                            <div class="-mr-2 flex items-center md:hidden">
                                                <button type="button"
                                                    class="bg-transparent rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-800 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white"
                                                    aria-expanded="false">
                                        ...
                                        <div class="hidden space-x-8 md:flex md:ml-10">
                                            <a href="#"
                                                class="text-base font-medium text-white hover:text-gray-300">ACCUEIL</a>

                                            <a href="#"
                                                class="text-base font-medium text-white hover:text-gray-300">CONCOURS</a>

                                            <a href="#"
                                                class="text-base font-medium text-white hover:text-gray-300">PROFILES</a>

                                            <a href="#"
                                                class="text-base font-medium text-white hover:text-gray-300">CONTACT</a>
                                            <a href="#"
                                                class="text-base font-medium text-white hover:text-gray-300">LOGIN</a>
                                            <a href="#"
                                                class="text-base font-medium text-white hover:text-gray-300">SIGNUP</a>
                ...
                -->
                            <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top md:hidden">
                                <div
                                    class="rounded-lg 1 bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                                    ...
                                    <div class="pt-5 pb-6">
                                        <div class="px-2 space-y-1">
                                            <a href="#"
                                                class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">ACCUEIL</a>

                                            <a href="#"
                                                class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">CONCOURS</a>

                                            <a href="#"
                                                class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">PROFILES</a>
                                        ...
                                        <div class="mt-6 px-5">
                                            <p class="text-center text-base font-medium text-gray-500">Existing
                                                Contestant? <a href="#"
                    ...
                    <div class="relative mt-10">
                        ...
                        <div class="relative   bg-white">
                            ...
                            <div class=" mx-auto bg-bittersweet-600 lg:bg-transparent lg:px-8">
                                <div class="lg:grid lg:grid-cols-12">
                                    ...
                                    <div
                                        class="relative bg-bittersweet-600 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                                                ...
                                                <defs>
                                                    <pattern id="64e643ad-2176-4f86-b3d7-f2c5da3b6a6d" x="0"
                                                        ...
                                                        <rect x="0" y="0" width="4"
                                                            height="4" class="text-bittersweet-500"
                                                            fill="currentColor" />
                                                    </pattern>
                                                </defs>
                    ...
                    <div class="flex justify-center items-center bg-white my-10">
                                    ...
                                    <div id="slider"
                                        ...
                                        <div class="flex flex-shrink-0 relative w-full sm:w-auto">
                                            <img src="{{ URL('image/carousel/2.jpg') }}" alt="1"
                                                class="object-cover object-center w-full sm:w-96" />
                                            <div class="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6"></div>
                                        </div>
                                        <div class="flex flex-shrink-0 relative w-full sm:w-auto">
                                            <img src="{{ URL('image/carousel/3.jpg') }}" alt="1"
                                                class="object-cover object-center w-full sm:w-96" />
                                            <div class="bg-gray-800 bg-opacity-30 absolute h-48 w-96 p-6"></div>
                                        </div>
                                        <div class="flex flex-shrink-0 relative w-full sm:w-auto">
                        ...
                        <div class="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
                            <div class="space-y-12">
                                <div class="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
                                    <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl">Categories</h2>
                                    <p class="text-xl text-gray-500">Odio nisi, lectus dis nulla. Ultrices maecenas
                        ...
                        <div class="max-w-7xl mx-auto py-12 px-4 text-center sm:px-6 lg:px-8 lg:py-24">
                            <div class="space-y-12">
                                <div class="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl">
                                    <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl">Contestants</h2>
                                    <p class="text-xl text-gray-500">Ornare sagittis, suspendisse in hendrerit quis.
...
<div class="bg-gray-100">
    <div class=" mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
      <div class="relative bg-white 1-xl">
        <h2 class="sr-only">Contact us</h2>

        <div class="grid grid-cols-1 lg:grid-cols-3">
          <!-- Contact information -->
          <div class="relative overflow-hidden py-10 px-6 bg-bittersweet-700 sm:px-10 xl:p-12" style="background-image:url({{ URL('image/map-image.png') }})">
            ...
            <p class="mt-6 text-base text-bittersweet-50 max-w-3xl">Nullam risus blandit ac aliquam justo ipsum. Quam mauris volutpat massa dictumst amet. Sapien tortor lacus arcu.</p>
            <dl class="mt-8 space-y-6">
              <dt><span class="sr-only">Phone number</span></dt>
              <dd class="flex text-base text-bittersweet-50">
                <!-- Heroicon name: outline/phone -->
                <svg class="flex-shrink-0 w-6 h-6 text-bittersweet-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <ul role="list" class="mt-8 flex space-x-12">
              <li>
                <a class="text-bittersweet-200 hover:text-bittersweet-100" href="#">
          ...
          <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
            ...
            <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
              <div>
                ...
                <div class="mt-1">
                  <input type="text" name="first-name" id="first-name" autocomplete="given-name" class="py-3 px-4 block w-full 1 text-gray-900 focus:ring-bittersweet-500 focus:border-bittersweet-500 border-gray-300 rounded-md">
                </div>
              </div>
              <div>
                <label for="last-name" class="block text-sm font-medium text-gray-900">Last name</label>
                <div class="mt-1">
                  <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="py-3 px-4 block w-full 1 text-gray-900 focus:ring-bittersweet-500 focus:border-bittersweet-500 border-gray-300 rounded-md">
                </div>
              </div>
              <div>
                <label for="email" class="block text-sm font-medium text-gray-900">Email</label>
                <div class="mt-1">
                  <input id="email" name="email" type="email" autocomplete="email" class="py-3 px-4 block w-full 1 text-gray-900 focus:ring-bittersweet-500 focus:border-bittersweet-500 border-gray-300 rounded-md">
                </div>
              </div>
              <div>
                ...
                <div class="mt-1">
                  <input type="text" name="phone" id="phone" autocomplete="tel" class="py-3 px-4 block w-full 1 text-gray-900 focus:ring-bittersweet-500 focus:border-bittersweet-500 border-gray-300 rounded-md" aria-describedby="phone-optional">
                </div>
              </div>
              <div class="sm:col-span-2">
                <label for="subject" class="block text-sm font-medium text-gray-900">Subject</label>
                <div class="mt-1">
                  <input type="text" name="subject" id="subject" class="py-3 px-4 block w-full 1 text-gray-900 focus:ring-bittersweet-500 focus:border-bittersweet-500 border-gray-300 rounded-md">
                </div>
              </div>
              <div class="sm:col-span-2">
                <div class="flex justify-between">
                ...
                <div class="mt-1">
                  <textarea id="message" name="message" rows="4" class="py-3 px-4 block w-full 1 text-gray-900 focus:ring-bittersweet-500 focus:border-bittersweet-500 border border-gray-300 rounded-md" aria-describedby="message-max"></textarea>
                </div>
              </div>
              <div class="sm:col-span-2 sm:flex sm:justify-end">
                <button type="submit" class="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md 1 text-base font-medium text-white bg-bittersweet-600 hover:bg-bittersweet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-bittersweet-500 sm:w-auto">
                  Submit
                </button>
              </div>
            </form>
